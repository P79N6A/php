...
REGION_NAME=$1
VERSION="1.0.1"
SVN_URL="svn://123.207.137.156/ptshare/client"
...
online_cluster="$CLIENT_HOST"
pre_online_cluster="$PRE_SERVICE_HOST"

# beta_cluster
beta_cluster="$TEST_HOST"

# 项目部署的目录， link 到  $REAL_REMOTE_DEPLOY_DIR 上
REMOTE_DEPLOY_DIR="/home/ptshare/codebase/$PROJECT_NAME"
# 部署的真实目录
REAL_REMOTE_DEPLOY_DIR="/home/ptshare/codebase/$PROJECT_NAME-$VERSION"
...
AUTORUN_PACKAGE_CMD="cd $REMOTE_DEPLOY_DIR;mkdir -p logs;ls -l"
