...
if (! defined('SERVER_CONF_COMMON')) {
    ...
    define("ERROR_LINK_APPLY_TIMES_LIMIT", 220004);
    define("ERROR_LINK_APPLY_NOT_IN_LIVEROOM", 220005);
...
$ERROR_LIST = array(
    ...
    ERROR_USER_ERR_BLACK => "您的追梦账号：%s(ID：%s)已被封禁，截止到%s解封，如有疑问请联系官方客服qq：23882823", // 封禁
    ...
    ERROR_BIZ_PAYMENT_WITHDRAW_AMOUNT_SMALL => '提现金额最小10元',
    ERROR_BIZ_PAYMENT_WITHDRAW_CASH_AMOUNT_SMALL => '提现金额最小100元',
    ...
    ERROR_BIZ_PAYMENT_STAR_DIAMOND_LIMIT=>'星星换星钻数额超限制',
    ...
    ERROR_LINK_APPLY_TIMES_LIMIT        => "主播连麦申请超限",
    ERROR_LINK_APPLY_NOT_IN_LIVEROOM    => "不在直播间",
...
//?主域名
define('MAIN_DOMAIN_NAME', 'dreamlive.com');
define('STATIC_DOMAIN_NAME', 'http://static.dreamlive.com');
