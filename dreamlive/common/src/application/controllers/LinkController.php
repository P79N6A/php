...
class LinkController extends BaseController
{
    ...
    public function cancelAction()
    {
        ...
        Interceptor::ensureNotFalse(($liveid = Live::isUserLive($uid)), ERROR_PARAM_NOT_SMALL_ZERO, "liveid");
        Interceptor::ensureNotFalse($uid > 0, ERROR_PARAM_NOT_SMALL_ZERO, "uid");
    ...
    public function acceptAction()
    {
        ...
        if($linktype == Link::LINK_TYPE_ANCHOR_USER) {
            Interceptor::ensureNotFalse(($liveid == Live::getLiveRoomByUser($uid)), ERROR_LINK_APPLY_NOT_IN_LIVEROOM, "uid");// 用户连麦，判断是否在主播的直播间
        }
