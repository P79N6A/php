...
class ShareController extends BaseController
{
    ...
    protected $targets     = array('wx', 'weibo', 'qq', 'qzone', 'circle','facebook', 'twitter');//微信好友、微信朋友圈、微博、QQ、QQ空间
    ...
    public function indexAction()
    {
        ...
        Interceptor::ensureNotFalse(in_array($type, $this->types), ERROR_PARAM_INVALID_FORMAT, 'type');
        Interceptor::ensureNotEmpty($relateid, ERROR_PARAM_IS_EMPTY, 'relateid');
        Interceptor::ensureNotFalse(in_array($target, $this->targets), ERROR_PARAM_INVALID_FORMAT, 'target');
