            ...
            if ($v) {
                ...
                if (in_array($live_author, array($uid, $fid)) && $liveid) {//主播关注观众或观众关注主播发群消息
                    if ($live_author == $uid) {
                        ...
                        Messenger::sendLiveFollowing($liveid, "主播关注了".$audience['nickname'], $uid, $fid, $audience['nickname'], $audience['avatar'], Messenger::MESSAGE_TYPE_FOLLOW_AUDIENCE, $audience['exp'], $audience['level'], 0, $audience['vip']);
                    } else {
