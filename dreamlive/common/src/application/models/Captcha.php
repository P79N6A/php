...
class Captcha
{
    ...
    */
    ...
    private static $_mail_msg = array(
        "reg"       => array(
            "subject" =>"[DreamApp]register",
            "content" =>"Thanks for registered in Dreamlive, your verify code is [%s], it is security information."
        ),
        "forgot"       => array(
            "subject" =>"[DreamApp] resetting password",
            "content" =>"We have received your request for resetting password, your verify code is [%s]. Forwarding the code to others may compromise your account."
        ),
    );
