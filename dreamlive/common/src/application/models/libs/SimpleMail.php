...
{/*{{{*/
    ...
    const POSRT = 465;
    const USER = "confirm@dreamlive.com";
    const PSW = "rm-Zeno35l1686wkxOp.mconfir";

    public static function send($to, $subject, $message, $altBody = "")
    {/*{{{*/
        $mail = new PHPMailer;
        $mail->isSMTP();
        $mail->SMTPSecure = "ssl";
        ...
        $mail->Host = self::HOST;
        $mail->Port = self::POSRT;
        $mail->SMTPAuth = true;
        $mail->Username = self::USER;
        $mail->Password = self::PSW;
        $mail->setFrom(self::USER, 'Dreamlive');
        $mail->addAddress($to, '');
