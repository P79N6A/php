...
class AccountAnswerInterface extends Account
{
    ...
    public static function cash($cash)
    {
        ...
        foreach ($cash as $key => $value){
            Messenger::sendSystemPublish(Messenger::MESSAGE_TYPE_BROADCAST_SOME, $key, "您在本轮追梦の百万富翁中过关斩将，获得最终的奖励金{$value}，我们已经将奖金发放到您的收益账户，请注意查收，有任何问题，请联系客服. ", "您在本轮追梦の百万富翁中过关斩将，获得最终的奖励金{$value}，我们已经将奖金发放到您的收益账户，请注意查收，有任何问题，请联系客服.", 0);
        }
