...
class DAOGameRobotsStar extends DAOProxy
{
    public function __construct()
    {
        $this->setDBConf("MYSQL_CONF_GAME");
        $this->setTableName("star_robots");
    }
     ...
     * 随机得到一个机器人
     */
    public function getGameRobotsOne()
    {
        ...
        foreach ($all as $i){
            ...
            $balance=$account_dao->getBalance(Account::CURRENCY_COIN);
