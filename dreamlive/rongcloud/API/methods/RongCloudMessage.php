...
class RongCloudMessage
{
    ...
    /**
     * http://www.rongcloud.cn/docs/push_service.html
     **/
    public function push($fromUserId,  $objectName, $content, $extra = array())
    {
        if (empty($fromUserId)) {
            throw new Exception('Paramer "fromUserId" is required');
        }
        ...
        'fromuserid' => $fromUserId,
        'audience' => array('is_to_all'=> true),
        'content' => $content,
        'alert' => $content,
        'objectName' => $objectName, 
        'notification'=> array('alert' => $content),
        'extras'    => $extra
        );
