...
# 项目名
PROJECT_NAME="process_client"
REGION_NAME=$1
VERSION="1.0.1"
SVN_URL="svn://192.168.1.168/dreamlive/process"
...
AUTORUN_PACKAGE_CMD="cd $REMOTE_DEPLOY_DIR;sh bootstrap.sh $REGION_NAME;ls -l;"
