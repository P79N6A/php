...
class ArtistVerifiedController extends BaseController
{
    public function applyAction()
    {
        ...
        $this->render();
        $artist_img_arr = parse_url($artist_img);
        $artist_img = $artist_img_arr['path'];
    ...
    public function getVerifiedInfoAction()
    {
        ...
        $this->render(
            ...
            'artist_img'=>STATIC_SERVER_NAME.$artist_info['artist_img'],
            )
        );
    }
    ...
    public function verifiedArtistAction()
    {
        ...
        if ($passed) {
            UserMedal::addUserMedal($uid, UserMedal::KIND_ARTIST, 'purple');
    ...
    public function cancelArtistAction()
    {
        ...
        $msg = "您的艺人认证已被取消";
        UserMedal::delUserMedal($uid, UserMedal::KIND_ARTIST);
