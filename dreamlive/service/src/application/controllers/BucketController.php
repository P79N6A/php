...
class BucketController extends BaseController
{
    ...
    public function setAction()
    {
        ...
        Interceptor::ensureNotEmpty($bucket_name, ERROR_PARAM_IS_EMPTY, 'bucket_name');
        Interceptor::ensureNotFalse(Bucket::checkBucketNameAndType($bucket_name, $type), ERROR_PARAM_INVALID_FORMAT, 'bucket_name&type not match');
    ...
    {
        $bucket_name = $this->getParam('bucket_name');
        $offset      = $this->getParam('offset') ? floatval($this->getParam('offset')) : 0;
        ...
        $this->render(
            ...
            'offset' => $next,
            'extends' => $bucket_info['extends'] ? $bucket_info['extends'] : ''
            )
        );
    }
