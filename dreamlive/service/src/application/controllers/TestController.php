...
class TestController extends  BaseController
{
    ...
    public function test123Action()
    {
        ...
        $uid = 23005712;
        $deviceid = '6f9a4e918af842e870567f3f5fc0fd95';
        $channel = 'hd001';
        ...
        if(!$cache->sIsmember($key, $deviceid)) {
            ...
            try {
                ...
                Interceptor::ensureNotFalse(self::decrease($systemid, $type, $orderid, self::$amount, $currency, $remark, $extends),  ERROR_BIZ_PAYMENT_CASH_BALANCE_DUE);
                Interceptor::ensureNotFalse(self::increase($key, $type, $orderid, self::$amount, $currency, $remark, $extends), ERROR_BIZ_PAYMENT_CASH_BALANCE_DUE);
    ...
    public function sendPackAction()
    {
        $packet     = new Packet();
        $bonus_total = 1000;
        $bonus_count = 5;
        ...
        $re = $packet->getBonus($bonus_total, $bonus_count, $bonus_max, $bonus_min);
        var_dump($re);
    }
