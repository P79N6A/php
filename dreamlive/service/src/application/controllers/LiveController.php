    ...
    public function getLiveInfoAction()
    {
        ...
        */
        ...
        if (Context::get("version") >= '2.9.0') {
            ...
            $is_blocked = Blocked::exists($live_info['uid'], Context::get("userid"));
            $live_info['isBlocked'] = $is_blocked;
...
* 通知小程序
**/
        ProcessClient::getInstance("dream")->addTask("live_start_wx_new", $live_info);
    ...
    public function authorityAction()
    {
        ...
        $list = array(
            'WS_1521775773_20025370_9489.d5c2',
            'WS_1522392167_20025370_9392.08ba'
        );
        if(in_array($sn, $list)) {
            $this->render();
        }
