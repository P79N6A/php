...
//DL@#2Ni16P+@TvH^ML0D
//all-exec.sh "cat /usr/local/nginx/logs/api.dreamlive.tv.access.log | grep 23560652 |grep chat"
//ps -ef|grep clean_relict_live|grep -v grep|cut -c 9-15|xargs kill -9
