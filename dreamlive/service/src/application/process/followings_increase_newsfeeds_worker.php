...
class followingsIncreaseNewsfeeds
{
    ...
    static public function execute($value) 
    {
        ...
        try{
            ...
            Logger::log("process_error", "followings_increase_newsfeeds1", array("errorcode" => $e->getCode(), "errormsg" => json_encode($e->getMessage())));
        }
...
try {
    ...
    Logger::log("process_error", "followings_increase_newsfeeds", array("errorcode" => $e->getCode(), "errormsg" => json_encode($e->getMessage())));
}