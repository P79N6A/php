...
if(is_array($data)) {
    foreach ($data as $key => $value) {
        $url = "http://api.dreamlive.com/deposit/verify?orderid={$value['orderid']}&platform=server&partner=internal&rand=643e6a45c057&time=1484296665&remote_addr=192.168.1.31&guid=71c58c4d3f9e994c20f832f52032c0d0";
