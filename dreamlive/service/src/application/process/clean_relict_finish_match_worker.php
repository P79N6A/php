    ...
    foreach ($all_matchs as $item) {
        ...
        if ($item['status'] == 0) {
            ...
            if ($now > $endtime) {
                ...
                Logger::log("pk_match_worker_log", "getWinner", array("matchid" => $item['matchid'],"winner"=> $winner));
                try{
                    ...
                    if (!empty($liveid)) {
                        if ($winner == $inviter) {
                               ...
                               Logger::log("pk_match_worker_log", "sendMatchWinner", array("matchid" => $item['matchid'],"winner"=> $winner));
            ...
            Logger::log("pk_match_worker_log", "okdone", array("matchid" => $item['matchid'], "status" => $item['status']));
        }
