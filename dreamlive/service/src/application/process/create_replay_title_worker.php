...
class CreateReplayTitleQueueWorker
{
    ...
    public static function execute($value)
    {
        ...
        try{
            ...
            Logger::log("process_error", "push_replay_title1", array("errorcode" => $e->getCode(), "errormsg" => json_encode($e->getMessage())));
        }
        return true;
    }
}
...
try {
    ...
    Logger::log("process_error", "push_replay_title", array("errorcode" => $e->getCode(), "errormsg" => json_encode($e->getMessage())));
}
?>