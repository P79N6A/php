...
$sql = "select uid, nickname, signature from user where modtime >= ?  ";
...
foreach ($user_list as $row) {
    var_dump($i . '----'.$total.'----' . $row['uid']);
    $option = array('nickname' => $row['nickname'],'uid' => $row['uid'], "signature" => $row['signature']);
