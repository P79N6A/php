...
start() {
        ...
        then
            ...
            if test "$?" -eq 0; then
                echo "handbookinger start success ......";
            else
                echo "handbookinger start fail ......";
            fi
...
stop() {
        ...
        if test "$?" -eq 0; then
             echo "handbookinger stop success ......";
        else
             echo "handbookinger stop fail ......";
        fi
}
...
restart() {
    ...
    if test "$?" -eq 0; then
         echo "run handbookinger success ......";
    else
         echo "run handbookinger fail ......";
    fi
}
