...
class Track
{
    public static function showTrackGift($sender, $receiver, $giftid, $num = 1,$liveid=0)
    {
        try{
                    ...
                    try{
                        ...
                        if (!empty($liveInfo)) {
                            if ($liveInfo['status']==Live::ACTIVING || $liveInfo['status']==Live::PAUSED) {
                                ...
                                $isJmp=(in_array($receiver, $big_live_list)&&$appName!=APP_NAME_DEFAULT)||!in_array($receiver, $big_live_list);
                                if ($isJmp) {
                                    $jmp=1;
                                }
                            }
                            ...
                            if(!empty($liveInfo['author']['nickname'])) {
                                $nickname=$liveInfo['author']['nickname'];
                            }
                            if(!empty($liveInfo['author']['avatar'])) {
                                $avatar=$liveInfo['author']['avatar'];
                            }
                            if(!empty($liveInfo['author']['medal'])) {
                                $medal=$liveInfo['author']['medal'];
                            }
                            ...
                            $privacyInfo = Privacy::getPrivacyInfoByLiveInfo($liveInfo['privacy']);
