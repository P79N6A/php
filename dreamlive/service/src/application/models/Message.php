...
class Message
{
    ...
    public function notice($sender, $liveid, $content)
    {
        ...
        try {
            ...
            Interceptor::ensureNotEmpty($star, ERROR_BIZ_PAYMENT_STAR_BALANCE_DUE, "$sender");
            Interceptor::ensureNotFalse($star>= $cost_star, ERROR_BIZ_PAYMENT_STAR_BALANCE_DUE, "$sender");
