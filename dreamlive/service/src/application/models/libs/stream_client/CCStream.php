...
class CCStream extends BaseStream
{
    ...
    const CN_PUSH       = "rtmp://cn02.push.zm361.com";
    const CN_FLV        = "http://cn02.flv.zm361.com";
    const CN_HLS        = "http://cn02.hls.zm361.com";
    const CN_REPALY     = "http://cn02.replay.zm361.com";
    
    const US_PUSH       = "rtmp://cn02.push.zm361.com";
    const US_FLV        = "http://cn02.flv.zm361.com";
    const US_HLS        = "http://cn02.hls.zm361.com";
    const US_REPALY     = "http://cn02.replay.zm361.com";
