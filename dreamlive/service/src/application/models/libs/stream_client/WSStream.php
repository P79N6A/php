...
{
    const CN_PUSH       = "rtmp://cn01.push.zm361.com";//"rtmp://cn01.push.wsxhy.com";
    const CN_FLV        = "http://cn01.flv.zm361.com";//"http://cn01.flv.wsxhy.com";
    const CN_HLS        = "http://cn01.hls.zm361.com";//"http://cn01.hls.wsxhy.com";
    const CN_REPALY     = "http://cn01.replay.zm361.com";//"http://cn01.replay.wsxhy.com";

    const US_PUSH       = "rtmp://cn01.push.zm361.com";//"rtmp://cn01.push.wsxhy.com";
    const US_FLV        ="http://cn01.flv.zm361.com"; //"http://cn01.flv.wsxhy.com";
    const US_HLS        = "http://cn01.hls.zm361.com";//"http://cn01.hls.wsxhy.com";
    const US_REPALY     = "http://cn01.replay.zm361.com";//"http://cn01.replay.wsxhy.com";
    ...
    public function getSpeedNode($region, $clientIp)
    {
        ...
        if ($env=='beta') {
            return array('url'=>['http://112.253.38.145/chinanetcenter/testup.flv?wsHost=cn01.dreamlive.com',],'partner'=>self::$partner);
        }
        $arrTemp = $url = array();
    ...
    public function pushList()
    {
        ...
        $k    = md5($r . $key);
        $u_arr=array(self::CN_PUSH,self::CN_FLV,self::CN_HLS);
        array_walk(
    ...
    {
        return str_replace(array('cn01.flv.zm361.com/live/','cn01.flv.zm361.com/replay/','cn01.hls.zm361.com/live/','cn01.hls.zm361.com/replay/'), '', $wsSn);
    }
