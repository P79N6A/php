<?php
require_once "WxPay.Exception.php"; //js
if ($_REQUEST['type'] == 'js' || strpos($_SERVER['REQUEST_URI'], 'notify_wechat_js')) {
    include_once "WxPay.H5.Config.php";
} else {
    include_once "WxPay.Config.php";   
}
require_once "WxPay.Data.php";
/**
 * 接口访问类，包含所有微信支付API列表的封装，类中方法为static方法，11
...
class WxPayApi
{
    ...
    public static function unifiedOrder($inputObj, $timeOut = 6)
    {
        ...
        if (Context::get('app_name')=='miniapp'&&$_REQUEST['type'] == 'js') {
            $inputObj->SetAppid(WxPayConfig::MINIAPPID);
        }
