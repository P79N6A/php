...
class AlipayPay
{
    ...
    const ALIPAY_NOTIFY_URL = "/deposit/notify_alipay";
    const ALIPAY_RETURN_URL = "/pay_complete.php";
    ...
    public static function prepare($uid, $source, $currency, $amount)
    {
        ...
        if ($_REQUEST['type'] == 'js') {        
            ...
            $config = array(
                ...
                'return_url' => $HTML5_DOMAIN . self::ALIPAY_RETURN_URL, 
                'notify_url' => $API_DOMAIN . self::ALIPAY_NOTIFY_URL
            );
            ...
            $request->setNotifyUrl($API_DOMAIN . self::ALIPAY_NOTIFY_URL);
