...
{
    static $_fields = "liveid, uid, title, sn, partner, `point`, province, city, district, location, width, height, `status`, subtitle, extends, addtime, endtime, modtime, replayurl, replay, `virtual`,region,cover,stime,etime,record, pullurl,privacy";
