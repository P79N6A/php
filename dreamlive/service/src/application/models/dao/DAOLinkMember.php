...
class DAOLinkMember extends DAOProxy
{
    ...
    {
        $condition = ' uid=? and relateid=? and linkid=? and liveid=? and status='.link::LINK_MEMBER_NOTACTIVING;
        $params = array(
            'uid'      => $uid,
            'relateid' => $relateid,
            'linkid'   => $linkid,
    ...
    {
        $condition = ' uid=? and relateid=? and  linkid=? and liveid=? and status='.Link::LINK_MEMBER_ACTIVING;
        $params = array(
            'uid'      => $uid,
            'relateid' => $relateid,
            'linkid'   => $linkid,
    ...
    {
        $condition = ' liveid=? and status='.Link::LINK_MEMBER_ACTIVING;
        $params = array(
            'liveid'   => $liveid
        );
        $option = array(
